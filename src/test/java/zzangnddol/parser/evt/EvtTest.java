...
public class EvtTest {
    ...
    public void testGotoLastRecord() throws IOException {
        Record record = getLastRecord("target/test-classes/eventfile/SecEvent.Evt");
        assertThat(
                record.fullString(),
        ...
        record = getLastRecord("target/test-classes/eventfile/SecEvent2.Evt");
        assertThat(
                record.fullString(),
                is("EVT[Security] 592 2015-04-22T06:11:03Z [1372,C:\\totalcmd\\TOTALCMD.EXE,1636,IEUser,IE8WINXP,(0x0,0xA84E)]"));
        record = getLastRecord("target/test-classes/eventfile/SecEvent3.Evt");
        assertThat(
                record.fullString(),
    ...
    private Record getLastRecord(String fileName) throws IOException {
        ...
        evt.gotoLastRecord();
        assertThat(evt.nextRecord(), is(nullValue()));
