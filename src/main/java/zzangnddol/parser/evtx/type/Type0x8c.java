...
public class Type0x8c extends VariantType {

    public Type0x8c(byte type, Chunk chunk, int start, short length, int context) {
    ...
    public void parseSelf() {
        ...
        for (int i = 0; i < elements; i++) {
            if (i != 0) buf.append("\n");
            buf.append(String.format("[%u] %e", i, buffer.getDouble()));
        }
